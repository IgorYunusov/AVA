...
#define pack754_16(f)   (  pack754((f), 16,  5)) //@r
#define pack754_32(f)   (  pack754((f), 32,  8))
#define pack754_64(f)   (  pack754((f), 64, 11))
#define unpack754_16(i) (unpack754((i), 16,  5)) //@r
...
//@r{
    else if (f ==  INFINITY) return 0x7f800000ULL << (bits - 32);
    else if (f == -INFINITY) return 0xff800000ULL << (bits - 32);
    else if (f != f)         return 0x7fc00000ULL << (bits - 32); // NaN
//@r}
